            ...
            for idx, product in products.iterrows():
                try:
                    ...
                    if "L1C" in product_name:
                        download_directory = r"C:\Users\marti\PycharmProjects\sentinelhub_API_volcanoes_satimages\Klyuchevskoy\Klyuchevskoy_2L1C_downloads"
                    elif "L2A" in product_name:
                        download_directory = r"C:\Users\marti\PycharmProjects\sentinelhub_API_volcanoes_satimages\Klyuchevskoy\Klyuchevskoy_2L2A_downloads"
                    else:
